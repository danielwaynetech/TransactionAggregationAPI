...
namespace TransactionAggregatorAPI.Tests.Controllers;
...
public class TransactionsControllerTests
{
    ...
    [Fact]
    public async Task GetCustomerTransactions_ShouldReturnInvalidCustomerId_WhenCustomerIdIsEmpty()
    {
        // Act
        Func<Task> act = () => _controller.GetCustomerTransactions(string.Empty, CancellationToken.None);
